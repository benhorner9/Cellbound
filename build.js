...
for(const file of files){
  ...
  if(file==='guild.html'){
    ...
    if(!contents.includes('quests-v1.css')||!contents.includes('quests-v1.js')||!contents.includes('id="quests"'))throw new Error('Quest Journal assets or hooks are not linked from guild.html');
