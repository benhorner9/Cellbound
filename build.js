...
for(const file of files){
  ...
  if(file==='boss-dossier-v1.js'){
    for(const hook of ["const VERSION='1.0.0'","'vaultheart'","'bound-choir'","'vorran'","'vex-calder'","'old-man'","async function show(","Skip the full briefing on future runs","window.CellboundBossDossier"])if(!contents.includes(hook))throw new Error('Final boss dossier runtime is missing '+hook);
  }
