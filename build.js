...
for(const file of files){
  ...
  if(file==='combat-reborn-v1.js'){
    ...
    if(!contents.includes("const VERSION='1.3.6'")||!contents.includes('tests:{run:runSelfTests}'))throw new Error('Canonical Combat Reborn engine/version is missing');
