...
for(const file of files){
  ...
  if(file==='guild.html'){
    if(!contents.includes('no-way-back-v1.css?v=2')||!contents.includes('no-way-back-v1.js?v=4'))throw new Error('No Way Back sail puzzle cache versions are stale in guild.html');
