...
const assets=['assets/gear/cellbound-gear-atlas.webp','assets/combat/status-icons-v1.webp','assets/bosses/ashen-vault-vaultheart.avif','assets/bosses/hollow-sanctum-bound-choir.avif','assets/bosses/chaos-canyon-vorran.avif','assets/bosses/blackout-station-calder.avif','assets/bosses/fractured-ages-old-man.avif'];
...
for(const file of files){
  ...
  if(file==='boss-dossier-v1.js'){
    for(const hook of ["const VERSION='1.1.0'","'vaultheart'","'bound-choir'","'vorran'","'vex-calder'","'old-man'","./assets/bosses/ashen-vault-vaultheart.avif","./assets/bosses/hollow-sanctum-bound-choir.avif","./assets/bosses/chaos-canyon-vorran.avif","./assets/bosses/blackout-station-calder.avif","./assets/bosses/fractured-ages-old-man.avif","async function show(","Skip the full briefing on future runs","window.CellboundBossDossier"])if(!contents.includes(hook))throw new Error('Final boss dossier runtime is missing '+hook);
  }
...
for(const file of ['assets/bosses/ashen-vault-vaultheart.avif','assets/bosses/hollow-sanctum-bound-choir.avif','assets/bosses/chaos-canyon-vorran.avif','assets/bosses/blackout-station-calder.avif','assets/bosses/fractured-ages-old-man.avif']){if(!fs.existsSync(path.join(out,file)))throw new Error(`Missing final boss artwork in production package: ${file}`)}
