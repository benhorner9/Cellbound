...
for(const file of files){
  ...
  if(file==='guild.html'){
    ...
    if(!contents.includes('quests-v2.js?v=37')||!contents.includes('thirteenth-bell-v1.js?v=6')||!contents.includes('no-way-back-v1.js?v=10'))throw new Error('Progressive quest combat cache versions are stale in guild.html');
