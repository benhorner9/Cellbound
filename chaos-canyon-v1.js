...
const STAGES=[
 ...
 {id:'vorran',title:'Archdruid Vorran',kind:'FINAL BOSS',combatKind:'final',level:11,enemyTypes:['boss'],enemyHealth:1900,enemies:['Archdruid Vorran'],mechanics:[{name:'Rejuvenation',type:'self-heal',duration:1900,healPct:.09}],phases:[{id:'vorran-close-one',name:'The Canyon Closes',atPct:75,damageScale:1.04},{id:'vorran-close-two',name:'Roots Close In',atPct:50,damageScale:1.08},{id:'vorran-unbound',name:'True Chaos',atPct:25,damageScale:1.18,addMechanics:[{name:'Wild Wrath: Unbound',type:'circles',duration:1200}]}]}
];
const ROUTE=[
