...
function renderWorld(){
  ...
  root.querySelectorAll('[data-world-attack]').forEach(b=>b.onclick=()=>attackBoss(b.dataset.worldAttack,b));
}
...
async function init(){
  ...
  window.CellboundSocial={refreshAll,loadWorld,loadGroups,loadChat};
}
init();
})();