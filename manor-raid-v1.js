...
function manorEncounter(stage){
 if(stage==='butler')return{id:'manor-butler',title:'The Butler',kind:'boss',level:15,enemies:[{name:'The Butler',classification:'boss',passive:true}],enemyHealth:5000,mechanicIntervalMs:2400,mechanics:[{name:'Thrown Plate Barrage',type:'persistent-circle',duration:1100,persistMs:13000,tickMs:950,tickDamage:5,radius:13,targetRoles:['healer','dps'],preferRanged:true},{name:'Slow Patrol',type:'patrol',duration:1300}],phases:[{id:'service60',name:'Service Accelerates',atPct:60,addMechanics:[{name:'Thrown Plate Barrage',type:'persistent-circle',duration:1050,persistMs:13000,tickMs:950,tickDamage:5,radius:13,targetRoles:['healer','dps'],preferRanged:true}]},{id:'lastcourse30',name:'The Last Course',atPct:30,addMechanics:[{name:'Thrown Plate Barrage',type:'persistent-circle',duration:950,persistMs:13000,tickMs:900,tickDamage:5,radius:13,targetRoles:['healer','dps'],preferRanged:true}]}],hardEnrageMs:70000};
