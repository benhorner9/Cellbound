...
const BOSSES={
  'vaultheart':{
    dungeon:'The Ashen Vault',name:'The Vaultheart',title:'The Living Core Beneath the Vault',theme:'ashen',
  ...
  'bound-choir':{
    dungeon:'The Hollow Sanctum',name:'The Bound Choir',title:'Voices Chained Beneath Zeltira',theme:'hollow',
  ...
  'vorran':{
    dungeon:'Chaos Canyon',name:'Archdruid Vorran',title:'Master of the Living Canyon',theme:'chaos',
  ...
  'vex-calder':{
    dungeon:'Blackout Station',name:'Dr. Vex Calder',title:'Architect of the Blackout',theme:'blackout',
  ...
  'old-man':{
    dungeon:'The Fractured Ages',name:'The Old Man',title:'Keeper of Ages',theme:'fractured',
