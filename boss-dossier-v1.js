...
const BOSSES={
  ...
  'three-hounds':{
    dungeon:'No Way Back',name:'The Three Hounds',title:'Guardians of the Manor Grounds',theme:'manor',artwork:'./assets/bosses/no-way-back-three-hounds-v3.jpg',
  ...
  'silas-vane':{
    dungeon:'No Way Back',name:'Silas Vane',title:'Master of the Manor',theme:'manor',artwork:'./assets/bosses/no-way-back-silas-vane-v3.jpg',
