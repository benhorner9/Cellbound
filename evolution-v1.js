...
let bankObserver=null,rosterObserver=null,professionObserver=null;
...
async function init(){
  ...
  bindRoster();bindBank();bindProfessions();bindGlobal();interceptWorldActions();dock();queueEnhance();
