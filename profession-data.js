...
const PROFESSIONS={
  Alchemy:{icon:'⚗',summary:'Brew dungeon consumables and the end-game Cell Shock recovery potion.',recipes:[
    {id:'alc-minor-tonic',name:'Minor Recovery Tonic',level:1,xp:18,inputs:{'ashen-soul-fragment':2},output:{category:'consumable',key:'minor-recovery-tonic',name:'Minor Recovery Tonic',quantity:1,payload:{effect:'recovery-tonic'}}},
  ...
  Enchanting:{icon:'✥',summary:'Turn soul reagents into tradeable runes and rare magical enhancements.',recipes:[
    {id:'enc-binding-rune',name:'Minor Binding Rune',level:1,xp:18,inputs:{'ashen-soul-fragment':2},output:{category:'consumable',key:'minor-binding-rune',name:'Minor Binding Rune',quantity:1,payload:{effect:'enchant-token',tier:1}}},
  ...
  Blacksmithing:{icon:'⚒',summary:'Forge Warrior and Paladin weapons and armour.',recipes:[
    {id:'bs-training-sword',name:'Training Sword',level:1,xp:20,inputs:{'warden-iron':2,'ashen-soul-fragment':1},output:{category:'gear',key:'warrior-t1-weapon',name:'Training Sword',quantity:1}},
  ...
  Leatherworking:{icon:'⌁',summary:'Craft Hunter and Rogue equipment from dungeon components.',recipes:[
    {id:'lw-leather-jerkin',name:'Leather Jerkin',level:1,xp:20,inputs:{'ashen-soul-fragment':2},output:{category:'gear',key:'hunter-t1-chest',name:'Leather Jerkin',quantity:1}},
  ...
  Tailoring:{icon:'✂',summary:'Create cloth and ritual gear for Priest, Mage and Druid characters.',recipes:[
    {id:'tail-blueweave',name:'Blueweave Robe',level:1,xp:20,inputs:{'ashen-soul-fragment':2},output:{category:'gear',key:'mage-t1-chest',name:'Blueweave Robe',quantity:1}},
